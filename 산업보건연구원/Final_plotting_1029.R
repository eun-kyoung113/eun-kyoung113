...
ggplot()+geom_line(data=L2b_join[ind.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.5)+labs(y="누적 발생 건수")+
  ...
  geom_ribbon(data=L2b_join[ind.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),fill='coral3',alpha = 0.35)+
  ...
  geom_ribbon(data=L2b_join[ind.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),fill='blue3',alpha = 0.35)+
...
ggplot()+geom_line(data=L2b_join[ind.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적 발생 건수")+
  ...
  geom_ribbon(data=L2b_join[ind.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L2b_join[ind.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L2ab_join[ind.M.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L2ab_join[ind.M.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L2ab_join[ind.M.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L2ab_join[ind.F.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L2ab_join[ind.F.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L2ab_join[ind.F.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L2ab_join[ind.M.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L2ab_join[ind.M.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L2ab_join[ind.M.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L2ab_join[ind.F.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L2ab_join[ind.F.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L2ab_join[ind.F.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3b_join[ind.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.6)+labs(y="누적 발생 건수")+
  ...
  geom_ribbon(data=L3b_join[ind.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3b_join[ind.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3b_join[ind.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적 발생 건수")+
  ...
  geom_ribbon(data=L3b_join[ind.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3b_join[ind.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3ab_join[ind.M.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L3ab_join[ind.M.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3ab_join[ind.M.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3ab_join[ind.F.01.raw,],aes(x=YEAR,y=LEUKEMIA_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L3ab_join[ind.F.01.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3ab_join[ind.F.234.pred,],aes(x=YEAR,ymin = LEUKEMIA_lo_final, ymax = LEUKEMIA_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3ab_join[ind.M.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L3ab_join[ind.M.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3ab_join[ind.M.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
...
ggplot()+geom_line(data=L3ab_join[ind.F.01.raw,],aes(x=YEAR,y=LUNG_final,color="red",linetype='solid'),size=0.6)+labs(y="누적발생건수")+
  ...
  geom_ribbon(data=L3ab_join[ind.F.01.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="coral3",alpha = .35)+
  ...
  geom_ribbon(data=L3ab_join[ind.F.234.pred,],aes(x=YEAR,ymin = LUNG_lo_final, ymax = LUNG_up_final),
              fill="blue3",alpha = .35)+
