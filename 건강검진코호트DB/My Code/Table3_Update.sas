...
/*********************************************/
/* MI, HF, TIA or Stroke, Cancer Smoking status */
/* 2 Category : Never VS Ever */
DATA data2;
SET dir1.Mydata;
IF SMK_STAT_TYPE_RSPS_CD ^='0';
...
proc freq data=data2;
tables Smoking * MI * Category;
RUN;

proc freq data=data2;
tables Smoking * Heart_failure * Category;
RUN;

proc freq data=data2;
tables Smoking * TIA_Stroke * Category;
RUN;

proc freq data=data2;
tables Smoking * Cancer * Category;
RUN;
