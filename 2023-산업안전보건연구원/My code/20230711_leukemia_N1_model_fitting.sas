/* Data split by YEAR and SEX and fitted time-varying covariate Cox-ph model */
...
%split_data_fitted_Cox(input_dataset=mine.final_leukemia_NO2, output_prefix=dt1);
