...
/*                                                               What TO DO                                                           */
/**********************************************************************************/
/* 1. 백혈병 발생 Outcome 대상, time-invariant covariate에서 “time-varying” covariate로 변환  */
...
/* 1. 이전에 생성한 “mine.final_leukemia_no2” tbl에서 leukemia_cancer_history=1, 즉, 개인 암 이력이 존재하는 객체의 distinct INDI_ID와 첫 암 진단 일자(fdx1)가져오기 */
proc sql;
...
/* 6. 개인 암 이력이 존재하는 객체 전부 대상, counting-process format으로 변환한 tbl 모두 rbind + time-varying “leukemia_cancer_history” covariate 변수 재정의 */
/* time-varying “leukemia_cancer_history” covariate는 첫 암 진단 일자 이후 모두 1의 값을 가짐. */
