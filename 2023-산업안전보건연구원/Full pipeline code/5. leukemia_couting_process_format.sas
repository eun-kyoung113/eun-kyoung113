...
/*                                                                     What TO DO                                                                                   */
/************************************************************************************************** */
/* 1. 백혈병 Outcome을 대상으로 “Outcome Category”, “Outcome date”, “between_yes” 변수 추가 생성                  */      
/* 2. Outcome을 백혈병으로 설정한 데이터를 Counting-process format으로 변환                                                     */
/************************************************************************************************** */
...
/* - “Outcome_Category” = ‘leukemia’ 이면서 Stop 시점이 Outcome_date와 동일한 경우 “Event” 변수 값에 1 부여 */
