...
<div align=center>
<p>
<img src="https://img.shields.io/badge/Apache%20Impala-147EFB?style=for-the-badge&logo=apacheimpala&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Looker%20Studio-E34F26?style=for-the-badge&logo=lookerstudio&logoColor=white" />
...
|근무기간|회사명|부서/직책|담당업무|
|-|-|-|-|
|2025.01~현재|TOSS|Data governance & Finance MarketPlace team / 계약직|Data Assistant
...
|-|-|-|-|-|
|2025.01~2025.05|${\cdot}$ 배치 파이프라인 적제 결과 QA 및 분석, 시각화 <br> ${\cdot}$ 데이터 라벨링|소비 카테고리 개선|Assistant|서비스 성능 향상 및 서비스 출시|
...
|2021.12~2023.05|${\cdot}$ Causal Inference <br> ${\cdot}$ Rare Exposure <br> ${\cdot}$ 건강보험청구자료|(**학위논문**)처치 군이 소수인 상황에서 처치 군 대상 평균 처치 효과 추론 방법론 비교|제 1저자|${\cdot}$ 한국정보통계학회 춘계학술대회 학생 우수 연구 <br> ${\cdot}$ 한국통계학회 하계학술대회 포스터논문상 수상 <br> **${\cdot}$ 응용통계학회 저널 게재**|
<br>

### 📆 경험
|기간|구분|기관/장소|내용|
|-|-|-|-|
|2024.11~2024.12|개인 스터디|Inflearn|데이터 리터러시 (지표 개념, 데이터 로그 설계 및 QA, A/B Test 등) 학습|
