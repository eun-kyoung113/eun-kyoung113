...
### Change Scenario & Exposure ratio = 0.5 ---------------------------
...
saveWorkbook(wb, "./Simulation Scenario code/Debugging_result/Ver0_Scenario_change_Ver4.p_0.5.xlsx")
