# Simulation code 9/28 Version --------------------------------------------
### <What to Do> ------------------------------------------------------------
## 1. Design Sandwich Variance of DR ATT Estimator
### -------------------------------------------------------------------------
...
### 2-3-1-3) Replication for comparison My function with sample variance --------------
DR_ATT_me<-c()
...
for(i in 1:1000){
  ...
  var_ATT_me[i] <- sandwich_var_DR("ATT",data,"E","Y",cov)
}

sample_var_me<-var(DR_ATT_me)*100
print(sample_var_me)
# [1] 10.12156

sandwich_var_DR("ATT",data,"E","Y",cov)*100
# [1] 49.58399
...
sample_var_me<-var(DR_ATT_me)*1000
print(sample_var_me)
# [1] 9.944465

sandwich_var_DR("ATT",data,"E","Y",cov)*1000
# [1] 62.46378
...
sample_var_me<-var(DR_ATT_me)*10000
print(sample_var_me)
# [1] 9.779789

sandwich_var_DR("ATT",data,"E","Y",cov)*10000
# [1] 73.03608
