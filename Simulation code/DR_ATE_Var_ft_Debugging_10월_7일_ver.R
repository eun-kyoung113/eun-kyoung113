...
### 2-3-1-3) 1000th Replication for check the estimating equation with true parameter set --------------
...
### 2-3-4-3) 1000th Replication for comparison My function with package --------------
z_true <- matrix(0, nrow=1000, ncol=9)
...
### 2-3-5-3) true Expectation of crossprod of estimating_equation calculate --------------
dim1<-9
...
apply(nu_true_array,c(1,2),mean) 
