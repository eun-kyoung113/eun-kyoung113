## consistency check of IPTW ATT Variance estimator - 7/8 update ver##
### 1. consistency test about mu_1, mu_0 with changing #of obs###
### 2. Use another formula about mu0 and mu1 ###
...
# 0.006597521
##############
true_B_mean<-0.5038109
true_C_mean<-0.006597521
...
############################ true value ###################################################
## 1. true mu1, true mu0 ##
true_mu0<-log(1.2)*true_B_mean + log(1.5)*true_C_mean
true_mu1<-true_mu0 + log(2)
################################################################################################

############################ version 1 : 315th row X  1000th data ################################
# sample store
B_sample<-matrix(0,nrow=315,ncol=1000)
C_sample<-matrix(0,nrow=315,ncol=1000)
U_sample<-matrix(0,nrow=315,ncol=1000)
E_sample<-matrix(0,nrow=315,ncol=1000)
Y_sample<-matrix(0,nrow=315,ncol=1000)
...
## Data store ##
write.csv(B_sample,file="B_sample_315.csv",row.names=FALSE)
write.csv(C_sample,file="C_sample_315.csv",row.names=FALSE)
#write.csv(U_sample,file="U_sample.csv",row.names=FALSE)
write.csv(E_sample,file="E_sample_315.csv",row.names=FALSE)
write.csv(Y_sample,file="Y_sample_315.csv",row.names=FALSE)

## Data import ##
B_sample<-read.csv("B_sample_315.csv",header=TRUE)
C_sample<-read.csv("C_sample_315.csv",header=TRUE)
#U_sample<-read.csv("U_sample.csv",header=TRUE)
E_sample<-read.csv("E_sample_315.csv",header=TRUE)
Y_sample<-read.csv("Y_sample_315.csv",header=TRUE)

######### check #############################################################
mu0_est_ver1<-rep(0,1000)
mu1_est_ver1<-rep(0,1000)

mu0_est_2_ver1<-rep(0,1000)
mu1_est_2_ver1<-rep(0,1000)
...
for(i in 1:1000){
  ...
  data$ps<-weight_result$model$fitted.values

  #mu0_est_ver1[i]<-sum(data$weight_untrimmed*(1-data$E)*data$Y)/sum(data$weight_untrimmed*(1-data$E))
  #mu1_est_ver1[i]<-sum(data$weight_untrimmed*data$E*data$Y)/sum(data$weight_untrimmed*data$E)
  
  mu0_est_2_ver1[i]<-sum((1-data$E)*data$Y/data$ps)/sum((1-data$E)/data$ps)
  mu1_est_2_ver1[i]<-sum((data$E)*data$Y/data$ps)/sum((data$E)/data$ps)
  
}

################################## version 2 : total 1250th row X  100th data #####################################
# sample store
B_sample<-matrix(0,nrow=1250,ncol=100)
C_sample<-matrix(0,nrow=1250,ncol=100)
U_sample<-matrix(0,nrow=1250,ncol=100)
E_sample<-matrix(0,nrow=1250,ncol=100)
Y_sample<-matrix(0,nrow=1250,ncol=100)
...
## Data store ##
write.csv(B_sample,file="B_sample_1250.csv",row.names=FALSE)
write.csv(C_sample,file="C_sample_1250.csv",row.names=FALSE)
#write.csv(U_sample,file="U_sample.csv",row.names=FALSE)
write.csv(E_sample,file="E_sample_1250.csv",row.names=FALSE)
write.csv(Y_sample,file="Y_sample_1250.csv",row.names=FALSE)

## Data import ##
B_sample<-read.csv("B_sample_1250.csv",header=TRUE)
C_sample<-read.csv("C_sample_1250.csv",header=TRUE)
#U_sample<-read.csv("U_sample.csv",header=TRUE)
E_sample<-read.csv("E_sample_1250.csv",header=TRUE)
Y_sample<-read.csv("Y_sample_1250.csv",header=TRUE)

###############################################################################
mu0_est_ver2<-rep(0,100)
mu1_est_ver2<-rep(0,100)

mu0_est_2_ver2<-rep(0,100)
mu1_est_2_ver2<-rep(0,100)
...
for(i in 1:100){
  ...
  #mu0_est_ver2[i]<-sum(data$weight_untrimmed*(1-data$E)*data$Y)/sum(data$weight_untrimmed*(1-data$E))
  #mu1_est_ver2[i]<-sum(data$weight_untrimmed*(data$E)*data$Y)/sum(data$weight_untrimmed*(data$E))
  
  mu0_est_2_ver2[i]<-sum((1-data$E)*data$Y/data$ps)/sum((1-data$E)/data$ps)
  mu1_est_2_ver2[i]<-sum((data$E)*data$Y/data$ps)/sum((data$E)/data$ps)
}

####################################################################################################################
################################## version 3 : total 5000th row X  100th data #####################################
# sample store
...
## Data store ##
write.csv(B_sample,file="B_sample_5000.csv",row.names=FALSE)
write.csv(C_sample,file="C_sample_5000.csv",row.names=FALSE)
#write.csv(U_sample,file="U_sample.csv",row.names=FALSE)
write.csv(E_sample,file="E_sample_5000.csv",row.names=FALSE)
write.csv(Y_sample,file="Y_sample_5000.csv",row.names=FALSE)

## Data import ##
B_sample<-read.csv("B_sample_5000.csv",header=TRUE)
C_sample<-read.csv("C_sample_5000.csv",header=TRUE)
#U_sample<-read.csv("U_sample.csv",header=TRUE)
E_sample<-read.csv("E_sample_5000.csv",header=TRUE)
Y_sample<-read.csv("Y_sample_5000.csv",header=TRUE)

###############################################################################
mu0_est_ver3<-rep(0,100)
mu1_est_ver3<-rep(0,100)

mu0_est_2_ver3<-rep(0,100)
mu1_est_2_ver3<-rep(0,100)
...
for(i in 1:100){
  ...
  #mu0_est_ver3[i]<-sum(data$weight_untrimmed*(1-data$E)*data$Y)/sum(data$weight_untrimmed*(1-data$E))
  #mu1_est_ver3[i]<-sum(data$weight_untrimmed*(data$E)*data$Y)/sum(data$weight_untrimmed*(data$E))
  
  mu0_est_2_ver3[i]<-sum((1-data$E)*data$Y/data$ps)/sum((1-data$E)/data$ps)
  mu1_est_2_ver3[i]<-sum((data$E)*data$Y/data$ps)/sum((data$E)/data$ps)
}
...
###############################################################################
mu0_est_ver4<-rep(0,100)
mu1_est_ver4<-rep(0,100)

mu0_est_2_ver4<-rep(0,100)
mu1_est_2_ver4<-rep(0,100)
...
for(i in 1:100){
  ...
  #mu0_est_ver4[i]<-sum(data$weight_untrimmed*(1-data$E)*data$Y)/sum(data$weight_untrimmed*(1-data$E))
  #mu1_est_ver4[i]<-sum(data$weight_untrimmed*(data$E)*data$Y)/sum(data$weight_untrimmed*(data$E))
  
  mu0_est_2_ver4[i]<-sum((1-data$E)*data$Y/data$ps)/sum((1-data$E)/data$ps)
  mu1_est_2_ver4[i]<-sum((data$E)*data$Y/data$ps)/sum((data$E)/data$ps)
}

###### result table ver 1########
result<-matrix(0,nrow=4,ncol=4)
rownames(result)<-c("#of obs = 315", "#of obs = 1250", "#of obs = 5000", "#of obs = 20000")
colnames(result)<-c("bias of mu_0 estimator","variance of mu_0 estimator", "bias of mu_1 estimator","variance of mu_1 estimator")
result[1,]<-c(mean(mu0_est_ver1)-true_mu0, var(mu0_est_ver1), mean(mu1_est_ver1)-true_mu1, var(mu1_est_ver1))
result[2,]<-c(mean(mu0_est_ver2)-true_mu0, var(mu0_est_ver2), mean(mu1_est_ver2)-true_mu1, var(mu1_est_ver2))
result[3,]<-c(mean(mu0_est_ver3)-true_mu0, var(mu0_est_ver3), mean(mu1_est_ver3)-true_mu1, var(mu1_est_ver3))
result[4,]<-c(mean(mu0_est_ver4)-true_mu0, var(mu0_est_ver4), mean(mu1_est_ver4)-true_mu1, var(mu1_est_ver4))
result
...
rownames(result2)<-c("#of obs = 315", "#of obs = 1250", "#of obs = 5000", "#of obs = 20000")
colnames(result2)<-c("bias of mu_0 estimator","variance of mu_0 estimator", "bias of mu_1 estimator","variance of mu_1 estimator")
result2[1,]<-c(mean(mu0_est_2_ver1)-true_mu0, var(mu0_est_2_ver1), mean(mu1_est_2_ver1)-true_mu1, var(mu1_est_2_ver1))
result2[2,]<-c(mean(mu0_est_2_ver2)-true_mu0, var(mu0_est_2_ver2), mean(mu1_est_2_ver2)-true_mu1, var(mu1_est_2_ver2))
result2[3,]<-c(mean(mu0_est_2_ver3)-true_mu0, var(mu0_est_2_ver3), mean(mu1_est_2_ver3)-true_mu1, var(mu1_est_2_ver3))
result2[4,]<-c(mean(mu0_est_2_ver4)-true_mu0, var(mu0_est_2_ver4), mean(mu1_est_2_ver4)-true_mu1, var(mu1_est_2_ver4))
result2
