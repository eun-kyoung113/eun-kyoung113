...
### Change Scenario & Exposure ratio = 0.125 ---------------------------
...
saveWorkbook(wb, "./Simulation Scenario code/Debugging_result/Ver2_Scenario_change_Ver4.p_0.125.xlsx")
