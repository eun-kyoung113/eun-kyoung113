...
### Change Scenario & Exposure ratio = 0.25 ---------------------------
...
saveWorkbook(wb, "./Simulation Scenario code/Debugging_result/Ver0_Scenario_change_Ver4.p_0.25.xlsx")
