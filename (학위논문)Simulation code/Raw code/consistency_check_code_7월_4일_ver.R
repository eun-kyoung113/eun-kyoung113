## consistency check of IPTW ATT Variance estimator - 7/4 update ver##
### 1. consistency test about mu_1, mu_0 ###
### 2. consistency test about PS model ###
...
delta_ver1<-matrix(0,nrow=1000,ncol=3)
...
for(i in 1:1000){
  ...
  delta_ver1[i,]<-coef(weight_result$model)
  #mu0_est_ver1[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1])
  #mu1_est_ver1[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1]) + log(2)
}
...
delta_ver2<-matrix(0,nrow=100,ncol=3)
...
for(i in 1:100){
  ...
  weight_result<-weight_make("E",cov,estimate='ATT',data=data)
  delta_ver2[i,]<-coef(weight_result$model)
  #mu0_est_ver2[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1])
  #mu1_est_ver2[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1]) + log(2)
}
...
delta_ver3<-matrix(0,nrow=100,ncol=3)
...
for(i in 1:100){
  ...
  weight_result<-weight_make("E",cov,estimate='ATT',data=data)
  delta_ver3[i,]<-coef(weight_result$model)
  #mu0_est_ver3[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1])
  #mu1_est_ver3[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1]) + log(2)
}
...
delta_ver4<-matrix(0,nrow=100,ncol=3)
...
for(i in 1:100){
  ...
  weight_result<-weight_make("E",cov,estimate='ATT',data=data)
  delta_ver4[i,]<-coef(weight_result$model)
  #mu0_est_ver4[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1])
  #mu1_est_ver4[i]<-log(1.2)*mean(data$B[data$E==1]) + log(1.5)*mean(data$C[data$E==1]) + log(2)
}
...
result_ps<-matrix(0,nrow=4,ncol=6)
rownames(result_ps)<-c("#of obs = 100", "#of obs = 1000", "#of obs = 10000", "#of obs = 20000")
colnames(result_ps)<-c("bias of delta_0 estimator","variance of delta_0 estimator", "bias of delta_B estimator","variance of delta_B estimator",
                    "bias of delta_C estimator","variance of delta_C estimator")
result_ps[1,]<-c(mean(delta_ver1[,1])-true_delta0, var(delta_ver1[,1]), mean(delta_ver1[,2])-true_delta_b, var(delta_ver1[,2]),
              mean(delta_ver1[,3])-true_delta_c, var(delta_ver1[,3]))
result_ps[2,]<-c(mean(delta_ver2[,1])-true_delta0, var(delta_ver2[,1]), mean(delta_ver2[,2])-true_delta_b, var(delta_ver2[,2]),
                 mean(delta_ver2[,3])-true_delta_c, var(delta_ver2[,3]))
result_ps[3,]<-c(mean(delta_ver3[,1])-true_delta0, var(delta_ver3[,1]), mean(delta_ver3[,2])-true_delta_b, var(delta_ver3[,2]),
                 mean(delta_ver3[,3])-true_delta_c, var(delta_ver3[,3]))
result_ps[4,]<-c(mean(delta_ver4[,1])-true_delta0, var(delta_ver4[,1]), mean(delta_ver4[,2])-true_delta_b, var(delta_ver4[,2]),
                 mean(delta_ver4[,3])-true_delta_c, var(delta_ver4[,3]))
result_ps
