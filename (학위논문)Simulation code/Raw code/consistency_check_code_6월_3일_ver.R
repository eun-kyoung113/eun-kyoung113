## consistency check of IPTW ATT Variance estimator ##
library(boot)
library(tableone)
library(survey)
library(Hmisc)
...
var_true<-t(gg)%*%vcov_SEE%*%gg
#var_true=0.001156056
...
plot(var_est_ver2,xlab="replication",ylab="IPTW ATT Variance estimator",ylim=c(0,0.1),main="#of observation=1000")
abline(h=var_true,col='red')
...
plot(var_est_ver3,xlab="replication",ylab="IPTW ATT Variance estimator",ylim=c(0,0.002),main="#of observation=10000")
abline(h=var_true,col='red')
...
plot(var_est_ver4,xlab="replication",ylab="IPTW ATT Variance estimator",ylim=c(0,0.01),main="#of observation=20000")
abline(h=var_true,col='red')
...
result[1,]<-c(mean(var_est_ver1)-var_true,var(var_est_ver1))
result[2,]<-c(mean(var_est_ver2)-var_true,var(var_est_ver2))
result[3,]<-c(mean(var_est_ver3)-var_true,var(var_est_ver3))
result[4,]<-c(mean(var_est_ver4)-var_true,var(var_est_ver4))
result
