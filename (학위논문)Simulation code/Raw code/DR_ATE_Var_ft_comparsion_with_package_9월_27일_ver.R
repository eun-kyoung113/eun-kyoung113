# Simulation code 9/27 Version --------------------------------------------
### <What to Do> ------------------------------------------------------------
## 1. Comparison my Hardcoding Sandwich variance function of DR ATE with "drgee" package function
##  - replication : Make 1000 dataset which # of obs = 100
##                  then get two DR ATE Estimator (My function & package result
##  - get sample variance * 10

## 2. Make 1000 data set which # of obs = 100, 1000, 10000, ... --> repeated 1.
### -------------------------------------------------------------------------
...
### -------------------------------------------------------------------------
### 2-3) Consistency check of Variance estimator of DR ATE estimator ----------------------------------
...
### 2-3-1-3) Replication for comparison My function with package --------------
DR_ATE_me<-c()
DR_ATE_package<-c()
...
for(i in 1:1000){
  ...
  DR_ATE_package[i]<-result$coefficients
  
  ## my function
  DR_ATE_me[i]<-DR_estimator("ATE",data,"E","Y",cov)$est
  
}

sample_var_me<-var(DR_ATE_me)*100
print(sample_var_me)
# [1] 0.9966251

sample_var_package<-var(DR_ATE_package)*100
print(sample_var_package)
# [1] 0.9933766

#result$vcov
#E
#E 0.06062738 --> 6.062738

#sandwich_var_DR("ATE",data,"E","Y",cov)
# [1] 0.0004575162 --> 0.04575162
...
### 2-3-2-3) Replication for comparison My function with package --------------
DR_ATE_me<-c()
DR_ATE_package<-c()
...
sample_var_me<-var(DR_ATE_me)*1000
print(sample_var_me)
# [1] 9.966251

sample_var_package<-var(DR_ATE_package)*1000
print(sample_var_package)
# [1] 9.933766
...
sandwich_var_DR("ATE",data,"E","Y",cov)*1000
# [1] 0.0002414843
...
### 2-3-3-3) Replication for comparison My function with package --------------
DR_ATE_me<-c()
DR_ATE_package<-c()
...
sample_var_me<-var(DR_ATE_me)*10000
print(sample_var_me)
# [1] 9.750713

sample_var_package<-var(DR_ATE_package)*10000
print(sample_var_package)
# [1] 9.773969
...
sandwich_var_DR("ATE",data,"E","Y",cov)*10000
# [1] 0.006477602
...
sample_var_me<-var(DR_ATE_me)*20000
print(sample_var_me)
# [1] 8.960728

sample_var_package<-var(DR_ATE_package)*20000
print(sample_var_package)
# [1] 8.966187
...
sandwich_var_DR("ATE",data,"E","Y",cov)*20000
# [1] 2.655847e-08
...
sample_var_me<-var(DR_ATE_me)*50000
print(sample_var_me)
# [1] 9.163777

sample_var_package<-var(DR_ATE_package)*50000
print(sample_var_package)
# [1] 9.150782
