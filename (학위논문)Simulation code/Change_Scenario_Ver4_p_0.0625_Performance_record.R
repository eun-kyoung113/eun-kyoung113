...
### Change Scenario & Exposure ratio = 0.0625 ---------------------------
...
for(repl in 1:REPL){
  ...
  al<-c(-6.5, 0.7, 0.7, 0.5) # Version0
  #al<-c(-5.4, 0.7, 0.5, 0.5) -- Version1
...
ATT_2_performance[,"Sandwich_robust_var_coverage"]<-c(NA, mean(ATT_2_result$Sandwich_IPW_Coverage),
...
saveWorkbook(wb, "./Simulation Scenario code/Debugging_result/Ver0_Scenario_change_Ver4.p_0.0625.xlsx")
